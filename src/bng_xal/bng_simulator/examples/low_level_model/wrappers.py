"""
Wrapper utilities for Gym-like environments.
"""
...
class GymnaxWrapper(object):
    ...
    def __init__(self, env):
        """
        Initialize the Gym-like wrapper.
        """
        self._env = env
...
class FlattenObservationWrapper(GymnaxWrapper):
    ...
    def step(
        ...
        """
        Step the environment and return a flat observation and the state.
        Args:
            key: The PRNG key
                chex.PRNGKey
            state: The state of the environment
...
class LogWrapper(GymnaxWrapper):
    ...
    def reset(
        ...
        """
        Reset the environment and return the observation and the state.
        """
    ...
    def step(
        ...
        """
        Step the environment and return the observation and the state, and
        additional information such as the reward and whether the episode is
        done.
        """
...
class ClipAction(GymnaxWrapper):
    ...
    def step(self, key, state, action, params=None):
        """
        Step the environment and clip the action before stepping.
...
class TransformObservation(GymnaxWrapper):
    ...
    def reset(self, key, params=None):
        """
        Reset the environment and apply the transformation to the observation.
        """
        obs, state = self._env.reset(key, params)
...
class NormalizeVecObservation(GymnaxWrapper):
    ...
    def reset(self, key, params=None):
        """
        Reset the environment and store the normalization statistics.
        """
        obs, state = self._env.reset(key, params)
    ...
    def step(self, key, state, action, params=None):
        """
        Step the environment and normalize the observations.
        """
        obs, env_state, reward, done, info = self._env.step(
            key, state.env_state, action, params
        )
...
class NormalizeVecReward(GymnaxWrapper):
    ...
    def step(self, key, state, action, params=None):
        """
        Step the environment and normalize the rewards.
        """
        obs, env_state, reward, done, info = self._env.step(
            key, state.env_state, action, params
        )
